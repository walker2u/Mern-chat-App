            ...
            <Container component={"main"} maxWidth="xs" sx={{
                ...
                >
                    {isLogin ? (
                        //login......
                        <>
                            <Typography variant="h5" marginTop={'1rem'}>Login</Typography>
                            <form style={{
                                width: "100%",
                                marginTop: '1rem',
                                padding: '1rem'
                        ...
                        //register..........
                        <>
                            <Typography variant="h5" marginTop={'1rem'}>Register</Typography>
                            <form style={{
                                width: "100%",
                                marginTop: '1rem',
                                padding: '1rem'
                            ...
                            >
                                ...
                                <Stack postion={'relative'} width={'10rem'} margin={'auto'}>
                                    <Avatar
                                        sx={{
                                            width: '10rem',
                                            height: '10rem',
